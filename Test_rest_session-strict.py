...
def root():
    ...
    return {"message": "Chat API Web Service is running ..."}
...
def end_session(session_id: str):
    if session_id in sessions:
        ...
        return {"message": "Error in deleting session: {session_id}"}
        # raise HTTPException(status_code=200, detail="Session not found")
