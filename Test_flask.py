# ==============================================
#        No feedback, strict 20% probablity
# ==============================================
...
def retrieve(query, top_n=3):
    ...
    try:
        ...
        # results = [(VECTOR_DB[idx][0], 1 - distance) for idx, distance in zip(indices[0], distances[0])]
...
def chatbot_interaction(user_input):
    ...
    if not retrieved_knowledge:
        return "⚠️ No relevant context found. Please ask a different question."
